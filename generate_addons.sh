...
NODE_MIN_VERSION=6
BASE_DIR=${PWD}
MANIFEST=${BASE_DIR}/${ADDON}/manifest.json
...
CHROMIUM_MANIFEST=${BASE_DIR}/${ADDON}/manifest.json_google
...
FIREFOX_MANIFEST=${BASE_DIR}/${ADDON}/manifest.json_mozilla
